...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-rbsA2VBKQhggwzxH7pPCaAqO46MgnOM80zW1RWuH61DGLwZJEdK2Kadq2F9CUG65" crossorigin="anonymous">
    ...
    <script>
      ...
      window.addEventListener('load',function(){
		...
		pwCheck.addEventListener('blur',function(){
			...
			if(!pwCheck.value){
				signupMsg.innerHTML = '비밀번호 확인을 입력하세요';
				return;
			}
	...
	<!-- 로그인폼 -->
      <form name='signinForm'>
        ...
        <div class="form-floating">
          <input type="text" class="form-control start" required="required" id="id">
          <label for="id">id</label>
        </div>
        <div class="form-floating">
          <input type="password" class="form-control end" required="required" id="pw">
  ...
  <form name='signupForm' style='display: none;'>
    ...
    <div class="form-floating">
      <input type="text" class="form-control start" required="required" id="signUpId">
      <label for="signUpId">id</label>
    </div>
     <div class="form-floating">
      <input type="text" class="form-control middle" required="required" id="signUpName">
      <label for="signUpName">Name</label>
    </div>
    <div class="form-floating">
      <input type="password" class="form-control middle" required="required" id="signUpPw">
      <label for="signUpPw">Password</label>
    </div>
    <div class="form-floating">
      <input type="password" class="form-control end" required="required" id="pwCheck">
  ...
  <%
    ...
    String redirectURI = URLEncoder.encode("http://localhost:8080/naver/naver_callback", "UTF-8");
